...
<div class="core sub-core">
    ...
    <div class="container-items">
        ...
        <div style="height: 3rem" class="inputBox">
            <p style="font-size: 12px ; color: green">Lead Time : Time taken to get  item to the shop <br><br>
                * SPECIAL - IF YOUR SHOP IS REGISTERED UNDER GROCERY CATEGORY, UNIT PRICE SHOULD BE LESS THAN OR EQUAL TO THE SYTEM PRICE<br></p>
        </div>
        <div class="inputBox">
