...
<div class = "core" style="height: 60rem;">
    <div class = "core-orders" >
        ...
        <div class="charts">
            <div class="barChart" ">
                <canvas class="analytics" height="120rem" id="orderBarchart"  style= " position: absolute; max-width:650px"></canvas>
                <div class= "average" >
    ...
    <div class="core-revenue">
        ...
        <div class="charts">
            <div class="barChart">
                <canvas class="analytics" height="120rem" id="revenueBarchart"  style= " position: absolute; max-width:6500px"></canvas>
                <div class= "average" >
