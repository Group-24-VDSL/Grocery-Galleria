...
<section class="section-home">
    <div class="home-content">
        ...
        <div style="height: auto" class="core">
            <div class="customer-details">
                <h1 class="heading"> <span>Rider Details</span><span style="color: var(--text-color-light)" class="shop-id"></span></h1>
        ...
        <div style="height: auto" class="core">
            <div class="customer-details">
                ...
                <table class="cus-details">
                    ...
                    <tbody class="">
                    <tr>
                        <td>C00987</td><td>Sanduni Siriwardhane</td>
                        <td>No. 20 , Dhammadhinna Rd, Tangalle</td><td>0715800177</td>
                    </tr>
                    </tbody>
                </table>
            </div>
