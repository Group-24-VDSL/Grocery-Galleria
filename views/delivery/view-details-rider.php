        ...
        <div class="frm">
            ...
            <div class="display-grid delivery-view">
                <div class="delivery-view-details">
                    <div><?php echo $form->field($model,"Name",true);?></div>
                    <div><?php echo $form->field($model,"Address",true);?></div>
                    <div><?php echo $form->field($model,"Email",true);?></div>
                    <div><?php echo $form->field($model,"ContactNo",true);?></div>
                    <div><?php echo $form->field($model,"NIC",true);?></div>
                    <div><?php echo $form->field($model,"ProfilePic",true);?></div>
                </div>
