...
<!--                    <span> / </span>-->
                ...
                <div class="quantity">
                        <span>Qty :</span>
                        <input class="quantity-input" type="number" name="quantity" min=${item.Unit==4? 1:item.UWeight} max="${item.Unit==4? item.MaxCount :item.UWeight * item.MaxCount}" step=${item.Unit==4? 1:item.UWeight} value=${item.Unit==4? 1:item.UWeight} onkeydown="return false;">
                </div>
