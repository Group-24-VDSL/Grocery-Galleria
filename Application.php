...
//    public From $emailfrom;
    ...
    public function __construct($rootPath ,$config)
    {
        ...
        $this->authMiddleware=new AuthMiddleware([
            ...
            'Delivery' => ['riderRegister','riderRegister','viewriders','viewrider','vieworders','vieworder','viewDelivery','assignrider','viewdelivery','viewnewdelivery','viewongoingdelivery','viewcompletedelivery','newDelivery','onDelivery','pastDelivery','profile','getRiders','getRider','getRiderLocation','getRiderLocationData','deliveryInfo','assignRider'],
