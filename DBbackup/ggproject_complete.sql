...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2021 at 11:46 AM
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `cancelOrder` (IN `ID` INT)  SQL SECURITY INVOKER
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `checkStock` (IN `ID` INT)  SQL SECURITY INVOKER
UPDATE temporarycart tc
    JOIN shopitem si
ON
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `fullfillOrder` (IN `ID` INT, IN `Note` VARCHAR(1000) CHARSET utf8, IN `Recipient_Name` VARCHAR(100) CHARSET utf8, IN `Recipient_Num` VARCHAR(100) CHARSET utf8, IN `Delivery_Fee` FLOAT, IN `Total_Price` FLOAT)  SQL SECURITY INVOKER
BEGIN
DECLARE
...
INSERT INTO `cart` (`CartID`, `CustomerID`, `DateTime`)
VALUES (1, 7, ''2021 - 10 - 23 09:38:23''),
...
VALUES (2, ''Customer One'', ''Address eka'', ''customer1@gmail.com'', ''0332222548 '', ''Colombo'', ''Colombo'',
        ''{&quot;
lat
&quot;:
6.943458914658162,&quot;lng
&quot;:
79.9875427734375}'', ''''),
(7, ''Customer Two'', ''Address eka'', ''customer2@mailinator.com'', ''
0713004458'', ''Colombo'', ''Colombo'', ''{&quot;lat&quot;:6.932553034671361,&quot;lng&quot;:79.97106328125}'', ''GhIJkSVzLO-6G0ARIvau5iX-U0A'');
...
INSERT INTO `deliveryrider` (`RiderID`, `Name`, `Address`, `Email`, `ContactNo`, `NIC`, `ProfilePic`, `RiderType`)
VALUES (9, ''Rider One'', ''Address eka'', ''rider1@gmail.com'', ''0715555468 '', ''981557852V'',
        '' / public /img/placeholder-150.png '', 0);
...
INSERT INTO `item` (`ItemID`, `Name`, `ItemImage`, `Brand`, `UWeight`, `Unit`, `MRP`, `MaxCount`, `Category`)
VALUES (1, ''Brinjol'', '' / img / product - imgs / 9500000.jpg'', '''', 300, 0, 310, 10, 0),
...
INSERT INTO `login` (`UserID`, `Email`, `PasswordHash`, `Name`, `Verify_Flag`, `Delete_Flag`, `Role`)
VALUES (2, ''customer1@gmail.com'', ''$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK'', ''Customer One'',
        1, 0, ''Customer''),
       (3, ''shop1@gmail.com'', ''$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK'', ''Shop One'', 1, 0,
        ''Shop''),
       (4, ''shop2@gmail.com'', ''$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK'', ''Shop Two'', 1, 0,
        ''Shop''),
       (5, ''shop3@gmail.com'', ''$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK'', ''Shop Three'', 0, 0,
        ''Shop''),
       (7, ''customer2@gmail.com'', ''$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK'', ''Customer Two'',
        1, 0, ''Customer''),
       (8, ''delivery1@gmail.com'', ''$2y$10$t0N5xYthgYV63x9DKNxFH.RipNC9S.KNJK/QLw0sSNAK9Sk4x4Sfu'', ''Delivery One'',
        1, 0, ''Delivery''),
       (9, ''rider1@gmail.com'', ''$2y$10$t0N5xYthgYV63x9DKNxFH.RipNC9S.KNJK/QLw0sSNAK9Sk4x4Sfu'', ''Rider One'', 1, 0,
        ''Rider''),
...
INSERT INTO `orders` (`OrderID`, `CartID`, `OrderDate`, `RecipientName`, `Note`, `RecipientContact`, `DeliveryCost`,
                      `TotalCost`)
VALUES (1, 1, ''2021 - 10 - 23 09:00:00'', NULL, NULL, NULL, 140, 1500),
...
VALUES (4, ''Shop Two'', ''Address Eka'', ''shop2@gmail.com'', ''0701122412 '', ''Colombo'', ''Colombo'',
        ''Kalinga Stores'', ''Fresh Stuff'', 0, ''{&quot;
lat
&quot;:
6.938006006240303,&quot;lng
&quot;:
79.916131640625}'', ''ChIJI4abT9RZ4joR83K0Sg1HrtI''),
(5, ''Shop Three'', ''
22/2 Old Kesbewa Road, Nugegoda.'', ''shop3@gmail.com'', ''
0778571737'', ''Colombo'', ''Colombo'', ''Senarath Grocery'', ''Farm Fresh Goods'', 0, ''{&quot;lat&quot;:6.8672672,&quot;lng&quot;:79.8856714}'', ''ChIJr_pa_k9a4joR0Lc1vOefaMQ'');
...
INSERT INTO `shopitem` (`ItemID`, `ShopID`, `UnitPrice`, `Stock`, `Enabled`)
VALUES (1, 5, 280, 20, 0),
       (2, 5, 100, 20, 0),
       (3, 5, 150, 20, 1),
       (4, 5, 380, 10, 1),
...
INSERT INTO `shoporder` (`ShopID`, `CartID`, `Date`, `ShopTotal`)
VALUES (4, 3, ''2021 - 12 - 03 '', 7100),
       (5, 3, ''2021 - 12 - 03 '', 7100);
...
INSERT INTO `temporarycart` (`ItemID`, `ShopID`, `CustomerID`, `Quantity`, `Purchased`)
VALUES (1, 5, 2, 10, 1),
       (2, 5, 2, 2, 1),
       (3, 5, 2, 4, 1),
       (5, 5, 2, 8, 0),
