...
--
CREATE
DATABASE IF NOT EXISTS `ggproject` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE
`ggproject`;
...
--
CREATE
DEFINER=`root`@`localhost` PROCEDURE `cancelOrder` (IN `ID` INT)
UPDATE temporarycart tc
SET tc.Purchased=0
WHERE tc.CustomerID = ID$$

CREATE
DEFINER=`root`@`localhost` PROCEDURE `checkStock` (IN `ID` INT)
UPDATE temporarycart tc
    JOIN shopitem si
ON
...
WHERE
    tc.CustomerID=ID
  AND
    (si.Stock-tc.Quantity)
    > 0$$

CREATE
DEFINER=`root`@`localhost` PROCEDURE `email_update` (IN `Id` INT, IN `Mail` VARCHAR(55))
BEGIN
UPDATE `login`
SET `Email`=Mail
WHERE `UserID` = Id;
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `fullfillOrder` (IN `ID` INT, IN `Note` VARCHAR(1000) CHARSET utf8, IN `Recipient_Name` VARCHAR(100) CHARSET utf8, IN `Recipient_Num` VARCHAR(100) CHARSET utf8, IN `Delivery_Fee` FLOAT, IN `Total_Price` FLOAT)
BEGIN
DECLARE
...
SET
@cartid = LAST_INSERT_ID();

INSERT INTO `orders` (CartID, RecipientName, Note, RecipientContact, DeliveryCost, TotalCost)
VALUES (@cartid, Recipient_Name, Note, Recipient_Num, Delivery_Fee, Total_Price);
SET
@orderid = LAST_INSERT_ID();
INSERT INTO `ordercart` (CartID, ShopID, ItemID, Quantity, Total)
SELECT @cartid AS CartID, tc.ShopID, tc.ItemID, tc.Quantity, (si.UnitPrice * tc.Quantity) AS Total
from `temporarycart` AS tc
         INNER JOIN `shopitem` AS si ON si.ShopID = tc.ShopID AND tc.ItemID = si.ItemID
WHERE tc.Purchased = 1
  AND tc.CustomerID = ID;

INSERT INTO `shoporder` (ShopID, CartID, ShopTotal)
SELECT tc.ShopID, @cartid AS CartID, SUM(si.UnitPrice * tc.Quantity)
from `temporarycart` AS tc
...
INSERT INTO `cart` (`CartID`, `CustomerID`, `Date`, `Time`)
VALUES (1, 7, '2021-12-04', '14:52:46'),
...
INSERT INTO `customer` (`CustomerID`, `Name`, `Address`, `Email`, `ContactNo`, `City`, `Suburb`, `Location`, `PlaceID`)
VALUES (2, 'Dilshan Thenuka', '22/2 Old Kesbewa Road, Nugegoda.', 'customer1@gmail.com', '+9477 8571737', '0', '8',
        '{&quot;lat&quot;:6.871714052860769,&quot;lng&quot;:79.89268108720779}', 'ChIJCSTj6ENa4joReFLBb54J8rk'),
       (7, 'Nadil Sankara', '22, 40 Old Kesbewa Rd, Nugegoda', 'customer2@mailinator.com', '+94774381695', '0', '8',
        '{&quot;lat&quot;:6.871743345215753,&quot;lng&quot;:79.89361717815399}', 'ChIJL9QBVg5b4joRH8BMOlx_Mk8');
...
INSERT INTO `delivery` (`DeliveryID`, `RiderID`, `Date`, `Status`, `CompTime`, `OrderID`, `CartID`)
VALUES (1, 9, '2021-12-22 15:05:06', 0, NULL, 1, 1);
...
INSERT INTO `deliveryrider` (`RiderID`, `Name`, `Address`, `Email`, `ContactNo`, `NIC`, `ProfilePic`, `City`, `Suburb`,
                             `RiderType`)
VALUES (9, 'Kamal Jayawardhana', '32, Pelawatta Rd, Nugegoda', 'rider1@gmail.com', '0715555468', '981557852V',
        '/public/img/placeholder-150.png', '0', '8', 0),
       (11, 'Seenath Batagedara', '13, Edirigoda Road, Nugegoda', 'rider2@gmail.com', '0754555257', '985452455V',
        '/public/img/placeholder-150.png', '0', '8', 0),
       (12, 'Janith Jaalitha', '19 A1, Chapel Rd, Nugegoda', 'rider3@gmail.com', '0754555257', '985478545V',
        '/public/img/placeholder-150.png', '0', '8', 1),
       (13, 'Sunil Keerthi', 'Chapel Rd, Nugegoda', 'rider4@gmail.com', '0754555257', '984578645V',
        '/public/img/placeholder-150.png', '0', '8', 1);
...
INSERT INTO `item` (`ItemID`, `Name`, `ItemImage`, `Brand`, `UWeight`, `Unit`, `MRP`, `MaxCount`, `Category`, `Status`)
VALUES (1, 'Brinjol', '/img/product-imgs/9500000.jpg', '', 300, 0, 310, 10, 0, 1),
...
INSERT INTO `login` (`UserID`, `Email`, `PasswordHash`, `Name`, `Verify_Flag`, `Delete_Flag`, `Role`, `City`, `Suburb`,
                     `RegTime`)
VALUES (2, 'customer1@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Dilshan Thenuka', 1,
        0, 'Customer', 0, 8, '2022-03-21 14:26:18'),
       (3, 'shop1@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Pussallawa Meat Shop', 1,
        0, 'Shop', 0, 8, '2022-03-21 14:26:18'),
       (4, 'shop2@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'D&J Mini Mart', 1, 0,
        'Shop', 0, 8, '2022-03-21 14:26:18'),
       (5, 'shop3@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Deli Market', 0, 0,
        'Shop', 0, 8, '2022-03-21 14:26:18'),
       (7, 'customer2@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Nadil Sankara', 1, 0,
        'Customer', 0, 8, '2022-03-21 14:26:18'),
       (8, 'delivery1@gmail.com', '$2y$10$t0N5xYthgYV63x9DKNxFH.RipNC9S.KNJK/QLw0sSNAK9Sk4x4Sfu', 'Delivery One', 1, 0,
        'Delivery', 0, 8, '2022-03-21 14:26:18'),
       (9, 'rider1@gmail.com', '$2y$10$t0N5xYthgYV63x9DKNxFH.RipNC9S.KNJK/QLw0sSNAK9Sk4x4Sfu', 'Kamal Jayawardhana', 1,
        0, 'Rider', 0, 8, '2022-03-21 14:26:18'),
       (10, 'staff1@gmail.com', '$2y$10$t0N5xYthgYV63x9DKNxFH.RipNC9S.KNJK/QLw0sSNAK9Sk4x4Sfu', 'Staff One', 1, 0,
        'Staff', 1, 8, '2022-03-21 14:26:18'),
       (11, 'rider2@gmail.com', '$2y$10$N1rtCYTVup.hvDPrNvtt8.zOkLrT.VJ/fC6qnKD6wCRO6Lvj3OQVS', 'Seenath Batagedara', 1,
        0, 'Rider', 0, 8, '2022-03-21 14:26:18'),
       (12, 'rider3@gmail.com', '$2y$10$N1rtCYTVup.hvDPrNvtt8.zOkLrT.VJ/fC6qnKD6wCRO6Lvj3OQVS', 'Janith Jaalitha', 1, 0,
        'Rider', 0, 8, '2022-03-21 14:26:18'),
       (13, 'rider4@gmail.com', '$2y$10$N1rtCYTVup.hvDPrNvtt8.zOkLrT.VJ/fC6qnKD6wCRO6Lvj3OQVS', 'Sunil Keerthi', 1, 0,
        'Rider', 0, 8, '2022-03-21 14:26:18'),
       (14, 'shop4@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Delmage Meats', 0, 0,
        'Shop', 0, 8, '2022-03-21 14:26:18'),
       (15, 'shop5@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Geenath Traders', 0, 0,
        'Shop', 0, 8, '2022-03-21 14:26:18'),
       (16, 'shop6@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Kamala Enterprises', 1,
        0, 'Shop', 0, 8, '2022-03-21 14:26:18'),
       (17, 'shop7@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Nugegoda Fruit Shop', 1,
        0, 'Shop', 0, 8, '2022-03-21 14:26:18'),
       (18, 'shop8@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Akku Fresh Fruits', 1,
        0, 'Shop', 0, 8, '2022-03-21 14:26:18'),
       (19, 'shop9@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Meegamu Fish', 1, 0,
        'Shop', 0, 8, '2022-03-21 14:26:18'),
       (20, 'shop10@gmail.com', '$2y$10$LccaU64pC43mF4yhFgDMbu5HEqVaTdcRKz/5cPjEEaOiwdJuuR4aK', 'Ceylon Fisheries', 1,
        0, 'Shop', 0, 8, '2022-03-21 14:26:18'),
       (21, 'delivery2@gmail.com', '$2y$10$t0N5xYthgYV63x9DKNxFH.RipNC9S.KNJK/QLw0sSNAK9Sk4x4Sfu', 'Delivery one', 1, 0,
        'Delivery', 1, 2, '2022-03-21 14:26:18');
...
INSERT INTO `orders` (`OrderID`, `CartID`, `OrderDate`, `RecipientName`, `Note`, `RecipientContact`, `DeliveryCost`,
                      `TotalCost`, `Status`, `City`, `Suburb`)
VALUES (1, 1, '2021-12-04 14:52:46', '', '', '', 160, 14360, 0, 1, 2),
...
INSERT INTO `payment` (`PaymentID`, `OrderID`, `TotalPrice`)
VALUES (1, 1, 14360),
       (2, 2, 2554);
...
INSERT INTO `shop` (`ShopID`, `Name`, `Address`, `Email`, `ContactNo`, `City`, `Suburb`, `ShopName`, `ShopDesc`,
                    `Category`, `Location`, `PlaceID`)
VALUES (3, 'Farhir Fazil', '10 Chapel Rd, Nugegoda', 'shop1@gmail.com', '+94777854845', 0, 8, 'Pussallawa Meat Shop',
        'Fresh Meats', 2, '{&quot;lat&quot;:6.8727925429239685,&quot;lng&quot;:79.89321484680175}',
        'ChIJJ1JA2ENa4joRbWhiruJI4sI'),
       (4, 'Harin Jayawardhana', 'Chapel Ln, Nugegoda', 'shop2@gmail.com', '+94777875619', 0, 8, 'D&J Mini Mart',
        'Everything at One Place', 0, '{&quot;lat&quot;:6.872643418517776,&quot;lng&quot;:79.89244505281448}',
        'ChIJS5thDMZb4joRcFj3-om0oto'),
       (5, 'Sandun Kaluhitha', '22b Station Ln, Nugegoda 10250', 'shop3@gmail.com', '+94772369469', 0, 8, 'Deli Market',
        'One Stop for All Your Needs', 0, '{&quot;lat&quot;:6.871969695171068,&quot;lng&quot;:79.8919622551918}',
        'ChIJ3XwA50Na4joR_nza5cs8jWc'),
       (14, 'Saantha Pansilu', '45 Jambugasmulla Rd, Nugegoda', 'shop4@gmail.com', '+94772358741', 0, 8,
        'Delmage Meats', 'Processed Meats', 2, '{&quot;lat&quot;:6.871000384017071,&quot;lng&quot;:79.89284738416671}',
        'ChIJ6YqpvENa4joRAemVeNt6ur0'),
       (15, 'Saantha Pansilu', '45 Jambugasmulla Rd, Nugegoda', 'shop5@gmail.com', '+94772365985', 0, 8,
        'Geenath Traders', 'Vegetable Importers', 1,
        '{&quot;lat&quot;:6.8728644421745475,&quot;lng&quot;:79.89126756305694}', 'ChIJuyUCVUFa4joRg9mBFNK_wy4'),
       (16, 'Kamala Geegana', '1 Edirigoda Rd, Nugegoda', 'shop6@gmail.com', '+94772344582', 0, 8, 'Kamala Enterprises',
        'Fresh Vegetables', 1, '{&quot;lat&quot;:6.873250567593335,&quot;lng&quot;:79.89270522708892}',
        'ChIJF1avXUFa4joR_25N3N_SnyM'),
       (17, 'Thisara Prabudda', '107/1/1,Stanley Thilakarathna Mawatha,Nugegoda', 'shop7@gmail.com', '+9477556982', 0,
        8, 'Nugegoda Fruit Shop', 'All Kinds of Fruits', 4,
        '{&quot;lat&quot;:6.872374461881273,&quot;lng&quot;:79.89076598997116}', 'ChIJgXatAkRa4joRcYX_75Xt09U'),
       (18, 'Falil Ahmed', '15/4,St Joseph Rd,Nugegoda', 'shop8@gmail.com', '+9471300982', 0, 8, 'Nugegoda Fruit Shop',
        'Fruit Importers and Distributors', 4, '{&quot;lat&quot;:6.86985331888307,&quot;lng&quot;:79.89195554966926}',
        'ChIJuW2he0Na4joROPealbMO0_k'),
       (19, 'Gagana Randeepa', '107,Samudradevi Rd, Nugegoda', 'shop9@gmail.com', '+9470006982', 0, 8, 'Meegamu Fish',
        'All Kinds of Fish', 3, '{&quot;lat&quot;:6.870877888510723,&quot;lng&quot;:79.89095106239319}',
        'ChIJ3brXfURa4joRT3lK547-66E'),
       (20, 'Jalitha Kumara', '15/4,Stanley Tilakaratne Mawatha, Nugegoda', 'shop10@gmail.com', '+9478222582', 0, 8,
        'Ceylon Fisheries', 'Fish Importers and Distributors', 3,
        '{&quot;lat&quot;:6.871463736298677,&quot;lng&quot;:79.88989427204132}', 'ChIJEbwlPkRa4joRjjCy7M_tmOs');
...
INSERT INTO `staff` (`StaffID`, `Name`, `Address`, `ContactNo`, `Email`)
VALUES (10, 'Staff One', 'Address Eka', '0714584685', 'staff1@gmail.com');
...
INSERT INTO `systemcost` (`Date`, `Cost`)
VALUES ('2022-01-31 15:10:53', 55000),
       ('2022-02-28 15:14:38', 50000),
       ('2022-03-22 17:05:24', 350);
--
...
INSERT INTO `verification` (`UserID`, `VerificationCode`, `UniqueID`)
VALUES (11, 'yGM5xcT9Z2Si3d8EC4xBYdRM', 'GWxnwqSqH9xnaBB0614reDfJ');
...
--
CREATE
EVENT `itemSales` ON SCHEDULE EVERY 1 MONTH STARTS '2021-12-29 02:40:36' ENDS '2023-01-28 02:40:36' ON COMPLETION PRESERVE ENABLE DO INSERT INTO shopitemsales
